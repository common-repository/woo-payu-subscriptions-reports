...
function woo_payu_subscriptions_reports_activate(){
    ...
    wp_schedule_event( time(), 'daily', 'woo_payu_subscriptions_reports' );
    add_option('woo_payu_subscriptions_reports_redirect', true);
}

function woo_payu_subscriptions_reports_deactivation(){
    wp_clear_scheduled_hook( 'woo_payu_subscriptions_reports' );
}

register_activation_hook(__FILE__,'woo_payu_subscriptions_reports_activate');
register_deactivation_hook( __FILE__, 'woo_payu_subscriptions_reports_deactivation' );